...
const Header: React.FC = () => {
  ...
  return (
    <>
        <header className="w-full py-4 px-8 border-b border-gray-700 bg-gray-800/30 backdrop-blur-sm sticky top-0 z-40">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className="text-sm font-medium text-gray-300 hover:text-white transition-colors bg-white/10 px-3 py-1.5 rounded-md border border-white/10"
                >
