...
export type StartTab = 'upload' | 'generate' | 'idphoto' | 'portrait' | 'travel' | 'themed' | 'photography-service' | 'couple-group' | 'history';
  ...
  return (
    <div className="bg-gray-800/50 p-1 rounded-xl flex flex-wrap items-center justify-center gap-1 border border-gray-700 mt-4 mb-4">
      ...
      <button
        ...
        className={`px-5 py-3 rounded-lg text-base md:text-lg font-semibold transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 ${currentTab === 'history'
