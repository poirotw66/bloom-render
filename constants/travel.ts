...
export const TRAVEL_SCENES_INTERNATIONAL: TravelScene[] = [
  ...
  {
    id: 'eiffel',
    nameKey: 'travel.scene.eiffel',
    prompt: 'in front of the Eiffel Tower, Paris, travel photography, daytime',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 50,
  ...
  {
    id: 'iceland',
    nameKey: 'travel.scene.iceland',
    prompt: 'in Iceland, dramatic mountains, waterfall, nature landscape, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 45,
  ...
  {
    id: 'santorini',
    nameKey: 'travel.scene.santorini',
    prompt: 'in Santorini, Greece, white and blue buildings, sea, sunny day, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 55,
  ...
  {
    id: 'london',
    nameKey: 'travel.scene.london',
    prompt:
      'in London, Big Ben and Westminster Bridge in background, iconic red bus nearby, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 48,
  ...
  {
    id: 'rome',
    nameKey: 'travel.scene.rome',
    prompt: 'in Rome, Italy, in front of the Colosseum, historical ruins, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'barcelona',
    nameKey: 'travel.scene.barcelona',
    prompt: 'in Barcelona, Sagrada Familia in background, gaudi architecture, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 49,
  ...
  {
    id: 'swiss_alps',
    nameKey: 'travel.scene.swiss_alps',
    prompt:
      'in the Swiss Alps, snow-capped mountains, wooden chalet, breathtaking nature, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 52,
  ...
  {
    id: 'neuschwanstein',
    nameKey: 'travel.scene.neuschwanstein',
    prompt: 'at Neuschwanstein Castle, Germany, fairy tale castle on a hill, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'pisa',
    nameKey: 'travel.scene.pisa',
    prompt: 'at the Leaning Tower of Pisa, Italy, historical landmark, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 52,
  ...
  {
    id: 'athens',
    nameKey: 'travel.scene.athens',
    prompt:
      'at the Acropolis of Athens, Parthenon temple, historical greek ruins, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 56,
  ...
  {
    id: 'moscow',
    nameKey: 'travel.scene.moscow',
    prompt:
      "in Moscow, Red Square, Saint Basil's Cathedral with colorful domes, travel photography",
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 61,
  ...
  {
    id: 'venice',
    nameKey: 'travel.scene.venice',
    prompt:
      'in Venice, Italy, on a gondola in the grand canal, historic buildings, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'prague',
    nameKey: 'travel.scene.prague',
    prompt:
      'in Prague, Charles Bridge at sunset, old town medieval architecture, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 54,
  ...
  {
    id: 'amsterdam',
    nameKey: 'travel.scene.amsterdam',
    prompt:
      'in Amsterdam, historic houses along the canal, tulips in foreground, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'europe',
    x: 51,
  ...
  {
    id: 'shibuya',
    nameKey: 'travel.scene.shibuya',
    prompt: 'in Shibuya, Tokyo, busy street, city background, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 89,
  ...
  {
    id: 'taj_mahal',
    nameKey: 'travel.scene.taj_mahal',
    prompt: 'at the Taj Mahal, India, white marble palace, reflecting pool, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 71,
  ...
  {
    id: 'great_wall',
    nameKey: 'travel.scene.great_wall',
    prompt:
      'on the Great Wall of China, ancient stone wall winding through mountains, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 82,
  ...
  {
    id: 'mt_fuji',
    nameKey: 'travel.scene.mt_fuji',
    prompt:
      'with Mount Fuji in background, cherry blossoms (sakura), Japan nature, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 88,
  ...
  {
    id: 'dubai',
    nameKey: 'travel.scene.dubai',
    prompt: 'in Dubai, Burj Khalifa skyscraper background, modern luxury city, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 65,
  ...
  {
    id: 'petra',
    nameKey: 'travel.scene.petra',
    prompt: 'in Petra, Jordan, the Treasury building carved into pink rock, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 60,
  ...
  {
    id: 'ankor_wat',
    nameKey: 'travel.scene.ankor_wat',
    prompt:
      'at Angkor Wat temple, Cambodia, ancient stone architecture, reflection in water, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 79,
  ...
  {
    id: 'bali',
    nameKey: 'travel.scene.bali',
    prompt: 'in Bali, Indonesia, lush green rice terraces, tropical jungle, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 82,
  ...
  {
    id: 'seoul',
    nameKey: 'travel.scene.seoul',
    prompt: 'in Seoul, N Seoul Tower background, city view from mountain, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 85,
  ...
  {
    id: 'singapore',
    nameKey: 'travel.scene.singapore',
    prompt: 'in Singapore, Marina Bay Sands hotel background, modern bay view, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 79,
  ...
  {
    id: 'cappadocia',
    nameKey: 'travel.scene.cappadocia',
    prompt:
      'in Cappadocia, Turkey, dozens of hot air balloons in the sky over fairy chimneys, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 60,
  ...
  {
    id: 'kyoto',
    nameKey: 'travel.scene.kyoto',
    prompt:
      'in Kyoto, Japan, Fushimi Inari shrine with thousands of red torii gates, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 87,
  ...
  {
    id: 'halong_bay',
    nameKey: 'travel.scene.halong_bay',
    prompt:
      'in Ha Long Bay, Vietnam, limestone islands in emerald water, on a traditional junk boat, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 80,
  ...
  {
    id: 'bangkok',
    nameKey: 'travel.scene.bangkok',
    prompt:
      'in Bangkok, Thailand, at Wat Arun Temple of Dawn, river background, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 78,
  ...
  {
    id: 'borobudur',
    nameKey: 'travel.scene.borobudur',
    prompt:
      'at Borobudur Temple, Indonesia, massive stone stupas at sunrise, misty jungle view, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 80,
  ...
  {
    id: 'everest',
    nameKey: 'travel.scene.everest',
    prompt:
      'at Mount Everest Base Camp, snow-capped peaks, colorful prayer flags, extreme mountain nature, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'asia',
    x: 73,
  ...
  {
    id: 'sydney',
    nameKey: 'travel.scene.sydney',
    prompt: 'in Sydney, Opera House in background, harbor bridge, sunny day, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'oceania',
    x: 92,
  ...
  {
    id: 'nz_mountains',
    nameKey: 'travel.scene.nz',
    prompt:
      'in New Zealand, Lord of the Rings style mountains, blue lake, sweeping landscape, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'oceania',
    x: 98,
  ...
  {
    id: 'uluru',
    nameKey: 'travel.scene.uluru',
    prompt:
      'at Uluru (Ayers Rock), Australia, massive red monolithic rock in the outback, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'oceania',
    x: 86,
  ...
  {
    id: 'bora_bora',
    nameKey: 'travel.scene.bora_bora',
    prompt:
      'in Bora Bora, on a private overwater bungalow balcony, crystal clear turquoise lagoon, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'oceania',
    x: 8,
  ...
  {
    id: 'nyc',
    nameKey: 'travel.scene.nyc',
    prompt: 'in New York City, Times Square, city street, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 29,
  ...
  {
    id: 'grand_canyon',
    nameKey: 'travel.scene.grand_canyon',
    prompt:
      'at the Grand Canyon, Arizona, massive red rock canyons, vast landscape, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 19,
  ...
  {
    id: 'san_francisco',
    nameKey: 'travel.scene.san_francisco',
    prompt:
      'at the Golden Gate Bridge, San Francisco, red bridge background with fog, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 16,
  ...
  {
    id: 'banff',
    nameKey: 'travel.scene.banff',
    prompt:
      'in Banff National Park, Canada, turquoise lake, pine trees, snow mountains, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 18,
  ...
  {
    id: 'mexico',
    nameKey: 'travel.scene.mexico',
    prompt: 'at Chichen Itza pyramid, Mexico, Mayan ruins, tropical setting, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 25,
  ...
  {
    id: 'havana',
    nameKey: 'travel.scene.havana',
    prompt:
      'in Havana, Cuba, driving a classic vintage car on the malecon waterfront, colorful buildings, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'namerica',
    x: 27,
  ...
  {
    id: 'machu_picchu',
    nameKey: 'travel.scene.machu_picchu',
    prompt:
      'at Machu Picchu, Peru, ancient inca ruins over green mountains, clouds, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'samerica',
    x: 30,
  ...
  {
    id: 'rio',
    nameKey: 'travel.scene.rio',
    prompt:
      'in Rio de Janeiro, Christ the Redeemer statue in background, mountain harbor view, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'samerica',
    x: 38,
  ...
  {
    id: 'galapagos',
    nameKey: 'travel.scene.galapagos',
    prompt:
      'on the Galapagos Islands, posing near a giant tortoise, volcanic rock, ocean background, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'samerica',
    x: 24,
  ...
  {
    id: 'easter_island',
    nameKey: 'travel.scene.easter_island',
    prompt:
      'on Easter Island, standing in front of massive Moai stone statues, grassy hills, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'samerica',
    x: 19,
  ...
  {
    id: 'iguazu',
    nameKey: 'travel.scene.iguazu',
    prompt:
      'at Iguazu Falls, standing on the observation walkway, powerful cascading waterfalls, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'samerica',
    x: 35,
  ...
  {
    id: 'pyramids',
    nameKey: 'travel.scene.pyramids',
    prompt:
      'at the Pyramids of Giza, Egypt, ancient pyramids in the desert, sand dunes, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'africa',
    x: 59,
  ...
  {
    id: 'cape_town',
    nameKey: 'travel.scene.cape_town',
    prompt:
      'in Cape Town, South Africa, Table Mountain background, beautiful coast, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'africa',
    x: 55,
  ...
  {
    id: 'victoria_falls',
    nameKey: 'travel.scene.victoria_falls',
    prompt:
      'at Victoria Falls, massive waterfall mist, rainbow, lush vegetation, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'africa',
    x: 57,
  ...
  {
    id: 'serengeti',
    nameKey: 'travel.scene.serengeti',
    prompt:
      'on Serengeti safari, savanna landscape, acacia tree, sunset, wild animals background, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'africa',
    x: 60,
  ...
  {
    id: 'marrakesh',
    nameKey: 'travel.scene.marrakesh',
    prompt:
      'in Marrakesh, Morocco, bustling spice souk (market), intricate islamic tiles, travel photography',
    group: 'international',
    category: 'scenery',
    continent: 'africa',
    x: 48,
  ...
  {
    id: 'food_italy_pizza',
    nameKey: 'travel.food.italy_pizza',
    prompt:
      'eating a classic Neapolitan pizza with melted buffalo mozzarella and fresh basil, street side cafe in Naples Italy background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'food_france_croissant',
    nameKey: 'travel.food.france_croissant',
    prompt: 'holding a buttery flaky croissant in front of a cozy Parisian bistro, morning light',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 50,
  ...
  {
    id: 'food_spain_paella',
    nameKey: 'travel.food.spain_paella',
    prompt:
      'eating seafood paella from a large pan, vibrant yellow rice, shrimp and mussels, sunny Barcelona terrace background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 49,
  ...
  {
    id: 'food_germany_pretzel',
    nameKey: 'travel.food.germany_pretzel',
    prompt:
      'holding a giant salted pretzel at an outdoor beer garden in Munich, traditional wooden tables background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'food_uk_fishchips',
    nameKey: 'travel.food.uk_fishchips',
    prompt:
      'eating fish and chips wrapped in paper, crispy battered fish, large potato wedges, London street background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 48,
  ...
  {
    id: 'food_belgium_waffle',
    nameKey: 'travel.food.belgium_waffle',
    prompt:
      'eating a Brussels waffle topped with strawberries and chocolate sauce, medieval city square background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 51,
  ...
  {
    id: 'food_greece_gyro',
    nameKey: 'travel.food.greece_gyro',
    prompt:
      'eating a Greek gyro wrap with meat, tzatziki, and fries inside, white Santorini buildings background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 55,
  ...
  {
    id: 'food_portugal_tart',
    nameKey: 'travel.food.portugal_tart',
    prompt:
      'holding a Pastel de Nata (egg tart) with cinnamon sprinkles, historic Lisbon street background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 44,
  ...
  {
    id: 'food_switzerland_fondue',
    nameKey: 'travel.food.switzerland_fondue',
    prompt:
      'dipping bread into a pot of melted cheese fondue, snowy Swiss Alps through the window background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 52,
  ...
  {
    id: 'food_turkey_kebab',
    nameKey: 'travel.food.turkey_kebab',
    prompt: 'eating a Turkish kebab with grilled meat and vegetables, Istanbul skyline background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 60,
  ...
  {
    id: 'food_japan_sushi',
    nameKey: 'travel.food.japan_sushi',
    prompt:
      'eating high quality nigiri sushi at a traditional wooden counter, Tokyo sushi bar atmosphere',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 89,
  ...
  {
    id: 'food_japan_ramen',
    nameKey: 'travel.food.japan_ramen',
    prompt:
      'slurping a bowl of hot tonkotsu ramen with pork slices and egg, busy Tokyo lantern-lit alley background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 88,
  ...
  {
    id: 'food_korea_bibimbap',
    nameKey: 'travel.food.korea_bibimbap',
    prompt:
      'eating colorful bibimbap in a stone pot, mixing rice with vegetables and gochujang, Seoul city background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 85,
  ...
  {
    id: 'food_thailand_padthai',
    nameKey: 'travel.food.thailand_padthai',
    prompt:
      'eating Pad Thai at a vibrant Bangkok night market, stir-fried noodles with shrimp and peanuts',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 78,
  ...
  {
    id: 'food_vietnam_pho',
    nameKey: 'travel.food.vietnam_pho',
    prompt:
      'eating a bowl of beef Pho with fresh herbs and lime, sitting on a low plastic stool, Hanoi street background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 80,
  ...
  {
    id: 'food_india_curry',
    nameKey: 'travel.food.india_curry',
    prompt:
      'eating butter chicken curry with garlic naan bread, colorful Indian restaurant background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 71,
  ...
  {
    id: 'food_china_dimsum',
    nameKey: 'travel.food.china_dimsum',
    prompt:
      'eating dim sum from bamboo steamers, har gow and siu mai, traditional Cantonese teahouse background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 82,
  ...
  {
    id: 'food_singapore_crab',
    nameKey: 'travel.food.singapore_crab',
    prompt:
      'eating Singapore chili crab with mantou buns, waterfront dining at Marina Bay background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 79,
  ...
  {
    id: 'food_indonesia_satay',
    nameKey: 'travel.food.indonesia_satay',
    prompt: 'eating grilled meat satay with peanut sauce, tropical Bali beach sunset background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 82,
  ...
  {
    id: 'food_malaysia_laksa',
    nameKey: 'travel.food.malaysia_laksa',
    prompt:
      'eating spicy curry laksa with coconut milk broth, bustling Kuala Lumpur street background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 78,
  ...
  {
    id: 'food_philippines_adobo',
    nameKey: 'travel.food.philippines_adobo',
    prompt:
      'eating chicken adobo with white rice, savoring the soy and vinegar sauce, Manila setting',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 85,
  ...
  {
    id: 'food_usa_burger',
    nameKey: 'travel.food.usa_burger',
    prompt:
      'eating a massive juicy cheeseburger with fries, classic 1950s American diner background',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 29,
  ...
  {
    id: 'food_usa_hotdog',
    nameKey: 'travel.food.usa_hotdog',
    prompt: 'eating a New York style hot dog with mustard, busy Times Square background',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 30,
  ...
  {
    id: 'food_mexico_tacos',
    nameKey: 'travel.food.mexico_tacos',
    prompt:
      'eating authentic street tacos with cilantro and onions, colorful Mexico City market background',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 25,
  ...
  {
    id: 'food_canada_poutine',
    nameKey: 'travel.food.canada_poutine',
    prompt:
      'eating poutine with fries, cheese curds and hot gravy, snowy Quebec city street background',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 28,
  ...
  {
    id: 'food_usa_bbq',
    nameKey: 'travel.food.usa_bbq',
    prompt: 'eating Texas style smoked brisket and ribs, outdoor BBQ joint with rustic wood tables',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 25,
  ...
  {
    id: 'food_cuba_sandwich',
    nameKey: 'travel.food.cuba_sandwich',
    prompt:
      'eating a pressed Cuban sandwich with ham and pickles, vintage Havana street background',
    group: 'international',
    category: 'food',
    continent: 'namerica',
    x: 27,
  ...
  // South America Food
  {
    id: 'food_peru_ceviche',
    nameKey: 'travel.food.peru_ceviche',
    prompt:
      'eating fresh lime-marinated ceviche with sweet potato, Pacific ocean view at a Lima restaurant background',
    group: 'international',
    category: 'food',
    continent: 'samerica',
    x: 26,
  ...
  {
    id: 'food_brazil_steak',
    nameKey: 'travel.food.brazil_steak',
    prompt:
      'eating picanha steak from a large skewer, Brazilian churrascaria steakhouse background',
    group: 'international',
    category: 'food',
    continent: 'samerica',
    x: 38,
  ...
  {
    id: 'food_argentina_empanada',
    nameKey: 'travel.food.argentina_empanada',
    prompt: 'holding a golden brown beef empanada, rustic Buenos Aires cafe background',
    group: 'international',
    category: 'food',
    continent: 'samerica',
    x: 35,
  ...
  {
    id: 'food_chile_wine',
    nameKey: 'travel.food.chile_wine',
    prompt: 'tasting red wine at a beautiful Chilean vineyard, Andes mountains in background',
    group: 'international',
    category: 'food',
    continent: 'samerica',
    x: 31,
  ...
  {
    id: 'food_colombia_coffee',
    nameKey: 'travel.food.colombia_coffee',
    prompt: 'drinking a cup of premium Colombian coffee, lush green coffee plantation background',
    group: 'international',
    category: 'food',
    continent: 'samerica',
    x: 31,
  ...
  // Oceania Food
  {
    ...
    nameKey: 'travel.food.australia_meatpie',
    prompt: 'eating a classic Australian meat pie with tomato sauce, Sydney Opera House background',
    group: 'international',
    category: 'food',
    continent: 'oceania',
    x: 92,
  ...
  {
    id: 'food_australia_brunch',
    nameKey: 'travel.food.australia_brunch',
    prompt:
      'eating avocado toast with poached eggs at a trendy Melbourne cafe, bright and airy atmosphere',
    group: 'international',
    category: 'food',
    continent: 'oceania',
    x: 89,
  ...
  {
    id: 'food_nz_lamb',
    nameKey: 'travel.food.nz_lamb',
    prompt:
      'eating roasted New Zealand lamb chops with herbs, beautiful green rolling hills background',
    group: 'international',
    category: 'food',
    continent: 'oceania',
    x: 98,
  ...
  // Africa Food
  {
    id: 'food_morocco_tagine',
    nameKey: 'travel.food.morocco_tagine',
    prompt: 'eating a slow-cooked lamb tagine from a clay pot, intricate Marrakesh riad background',
    group: 'international',
    category: 'food',
    continent: 'africa',
    x: 48,
  ...
  {
    id: 'food_egypt_falafel',
    nameKey: 'travel.food.egypt_falafel',
    prompt: 'eating crispy hot falafels in pita bread, busy Cairo market background',
    group: 'international',
    category: 'food',
    continent: 'africa',
    x: 59,
  ...
  {
    id: 'food_safrica_biltong',
    nameKey: 'travel.food.safrica_biltong',
    prompt: 'eating South African biltong (dried meat), beautiful Cape Town coast background',
    group: 'international',
    category: 'food',
    continent: 'africa',
    x: 55,
  ...
  {
    id: 'food_ethiopia_injera',
    nameKey: 'travel.food.ethiopia_injera',
    prompt:
      'eating spicy doro wat stew on spongy injera flatbread, traditional Ethiopian dining setting',
    group: 'international',
    category: 'food',
    continent: 'africa',
    x: 62,
  ...
  // desserts & others
  {
    id: 'food_france_macaron',
    nameKey: 'travel.food.france_macaron',
    prompt: 'eating colorful macarons at a luxurious Paris pastry shop, pastel colors background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 50,
  ...
  {
    id: 'food_austria_sacher',
    nameKey: 'travel.food.austria_sacher',
    prompt: 'eating Sacher torte chocolate cake with whipped cream, elegant Vienna cafe background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 54,
  ...
  {
    id: 'food_italy_gelato',
    nameKey: 'travel.food.italy_gelato',
    prompt: 'eating a cone of Italian gelato, Florence historic cathedral background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 53,
  ...
  {
    id: 'food_denmark_pastry',
    nameKey: 'travel.food.denmark_pastry',
    prompt:
      'eating a Danish pastry with fruit filling, colorful Nyhavn harbor in Copenhagen background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 52,
  ...
  {
    id: 'food_middleeast_baklava',
    nameKey: 'travel.food.baklava',
    prompt: 'eating sweet honey baklava with pistachios, ornate Middle Eastern teahouse background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 63,
  ...
  {
    id: 'food_hongkong_eggtart',
    nameKey: 'travel.food.hk_eggtart',
    prompt: 'eating a Hong Kong style egg tart with flaky crust, bustling street market background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 81,
  ...
  },
  {
    ...
    nameKey: 'travel.food.russia_borscht',
    prompt:
      'eating a bowl of vibrant red beet borscht with sour cream, snowy Moscow square background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 61,
  ...
  {
    id: 'food_vietnam_coffee',
    nameKey: 'travel.food.vietnam_coffee',
    prompt:
      'drinking Vietnamese iced coffee with condensed milk, sitting on a low stool at a busy Saigon corner',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 81,
  ...
  {
    id: 'food_japan_matcha',
    nameKey: 'travel.food.japan_matcha',
    prompt: 'drinking ceremonial matcha green tea, traditional Japanese tatami tea room background',
    group: 'international',
    category: 'food',
    continent: 'asia',
    x: 87,
  ...
  {
    id: 'food_world_chocolate',
    nameKey: 'travel.food.world_chocolate',
    prompt: 'tasting luxury artisanal chocolates, elegant boutique chocolate shop background',
    group: 'international',
    category: 'food',
    continent: 'europe',
    x: 51,
...
export const TRAVEL_SCENES_TAIWAN: TravelScene[] = [
  ...
  {
    id: 'taipei101',
    nameKey: 'travel.scene.taipei101',
    prompt: 'in front of Taipei 101, towering skyscraper background, Taipei city skyline',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 55,
  ...
  {
    id: 'jiufen',
    nameKey: 'travel.scene.jiufen',
    prompt:
      'at Jiufen Old Street, red lanterns, narrow alleyway, traditional tea house architecture',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 62,
  ...
  {
    id: 'ximending',
    nameKey: 'travel.scene.ximending',
    prompt: 'in Ximending, neon signs, busy pedestrian street, vibrant urban atmosphere',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 48,
  ...
  {
    id: 'cks_memorial',
    nameKey: 'travel.scene.cks_memorial',
    prompt:
      'at Chiang Kai-shek Memorial Hall, large white building with blue roof, spacious liberty square',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 52,
  ...
  {
    id: 'raohe_market',
    nameKey: 'travel.scene.raohe_market',
    prompt: 'at Raohe Night Market entrance, glowing temple gate, busy street food stalls',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 58,
  ...
  {
    id: 'yehliu',
    nameKey: 'travel.scene.yehliu',
    prompt: 'at Yehliu Geopark, rock formations, Queens Head rock, ocean background',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 60,
  ...
  {
    id: 'shifen_waterfall',
    nameKey: 'travel.scene.shifen',
    prompt: 'at Shifen Waterfall, large cascade of water, nature scenery, green lush forest',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 64,
  ...
  {
    id: 'tamsui',
    nameKey: 'travel.scene.tamsui',
    prompt: 'at Tamsui Fishermans Wharf, Lovers Bridge, river sunset view, romantic atmosphere',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 46,
  ...
  {
    id: 'guiishan',
    nameKey: 'travel.scene.guiishan',
    prompt: 'with Guishan Island (Turtle Island) in the background, ocean view, Yilan coast',
    group: 'taiwan',
    category: 'scenery',
    region: 'north',
    x: 68,
  ...
  {
    id: 'gaomei',
    nameKey: 'travel.scene.gaomei',
    prompt: 'at Gaomei Wetlands, wind turbines in background, mirror-like water reflection, sunset',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 36,
  ...
  {
    id: 'taichung_theater',
    nameKey: 'travel.scene.theater',
    prompt: 'in front of National Taichung Theater, curved modern architecture, artistic building',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 42,
  ...
  {
    id: 'rainbow_village',
    nameKey: 'travel.scene.rainbow',
    prompt: 'at Rainbow Village in Taichung, colorful painted walls, vibrant art patterns',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 40,
  ...
  {
    id: 'sunmoonlake',
    nameKey: 'travel.scene.sunmoonlake',
    prompt: 'at Sun Moon Lake, calm blue water, layers of mountains, traditional boat dock',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 50,
  ...
  {
    id: 'qingjing',
    nameKey: 'travel.scene.qingjing',
    prompt: 'at Qingjing Farm, green rolling hills, sheep grazing, swiss-style architecture',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 54,
  ...
  {
    id: 'hehuanshan',
    nameKey: 'travel.scene.hehuanshan',
    prompt: 'on Hehuanshan mountain peak, sea of clouds, high altitude alpine scenery',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 56,
  ...
  {
    id: 'lugang',
    nameKey: 'travel.scene.lugang',
    prompt: 'in Lugang Old Street, red brick historic buildings, narrow lane, cultural heritage',
    group: 'taiwan',
    category: 'scenery',
    region: 'central',
    x: 34,
  ...
  {
    id: 'alishan',
    nameKey: 'travel.scene.alishan',
    prompt: 'in Alishan Forest, ancient giant cypress trees, misty railway track, forest train',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 45,
  ...
  {
    id: 'hinoki_village',
    nameKey: 'travel.scene.hinoki',
    prompt: 'at Hinoki Village Chiayi, japanese style wooden houses, zen garden atmosphere',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 42,
  ...
  {
    id: 'tainan_confucius',
    nameKey: 'travel.scene.confucius',
    prompt: 'at Tainan Confucius Temple, traditional red walls, peaceful courtyard, ancient trees',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 40,
  ...
  {
    id: 'chimei_museum',
    nameKey: 'travel.scene.chimei',
    prompt: 'in front of Chimei Museum, grand european classical palace architecture, fountain',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 41,
  ...
  {
    id: 'kaohsiung_music',
    nameKey: 'travel.scene.music_center',
    prompt: 'at Kaohsiung Music Center, futuristic honeycomb architecture, harbor view',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 40,
  ...
  {
    id: 'dragon_tiger',
    nameKey: 'travel.scene.dragontiger',
    prompt: 'at Dragon and Tiger Pagodas Kaohsiung, twin pagodas, lotus lake, colorful bridge',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 41,
  ...
  {
    id: 'formosa_boulevard',
    nameKey: 'travel.scene.dome',
    prompt: 'inside Formosa Boulevard Station, Dome of Light, colorful stained glass ceiling',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 42,
  ...
  {
    id: 'kenting',
    nameKey: 'travel.scene.kenting',
    prompt: 'at Kenting Baishawan beach, white sand, turquoise ocean, tropical palm trees',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 50,
  ...
  {
    id: 'eluanbi',
    nameKey: 'travel.scene.eluanbi',
    prompt:
      'at Eluanbi Lighthouse, white lighthouse, green grass, blue sky, southern tip of Taiwan',
    group: 'taiwan',
    category: 'scenery',
    region: 'south',
    x: 52,
  ...
  {
    id: 'taroko',
    nameKey: 'travel.scene.taroko',
    prompt: 'at Taroko Gorge, marble canyon walls, swallow grotto, turquoise river below',
    group: 'taiwan',
    category: 'scenery',
    region: 'east',
    x: 58,
  ...
  {
    id: 'qingshui_cliff',
    nameKey: 'travel.scene.qingshui',
    prompt: 'at Qingshui Cliff, steep cliffs dropping into the pacific ocean, dramatic coastline',
    group: 'taiwan',
    category: 'scenery',
    region: 'east',
    x: 60,
  ...
  {
    id: 'mr_brown_ave',
    nameKey: 'travel.scene.mrbrown',
    prompt: 'at Mr. Brown Avenue Chishang, endless green rice paddies, road leading to mountains',
    group: 'taiwan',
    category: 'scenery',
    region: 'east',
    x: 55,
  ...
  {
    id: 'sanxiantai',
    nameKey: 'travel.scene.sanxiantai',
    prompt: 'at Sanxiantai, eight-arch footbridge crossing the ocean, rocky coast',
    group: 'taiwan',
    category: 'scenery',
    region: 'east',
    x: 62,
  ...
  {
    id: 'penghu',
    nameKey: 'travel.scene.penghu',
    prompt: 'in Penghu, traditional coral stone wall houses, blue sky, island vibe',
    group: 'taiwan',
    category: 'scenery',
    region: 'islands',
    x: 20,
  ...
  {
    id: 'food_boba',
    nameKey: 'travel.food.boba',
    prompt:
      'drinking a classic Taiwan bubble milk tea, holding a plastic cup with large black pearls, urban street background',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 51,
  ...
  {
    id: 'food_beef_noodle',
    nameKey: 'travel.food.beef_noodle',
    prompt:
      'eating a bowl of Taiwan braised beef noodles, tender beef chunks, rich dark soup, holding chopsticks, steam rising',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 49,
  ...
  },
  {
    ...
    nameKey: 'travel.food.fried_chicken',
    prompt:
      'holding a huge Taiwan crispy fried chicken cutlet in a paper bag, taking a bite, street food market background',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 44,
  ...
  {
    id: 'food_xiaolongbao',
    nameKey: 'travel.food.xiaolongbao',
    prompt:
      'eating xiaolongbao (soup dumplings), holding one with chopsticks over a spoon, thin dough skin, steam rising, bamboo steamer in background',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 53,
  ...
  {
    id: 'food_stinky_tofu',
    nameKey: 'travel.food.stinky_tofu',
    prompt:
      'eating Taiwan crispy stinky tofu, topped with pickled cabbage, spicy paste, outdoor market setting',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 57,
  ...
  {
    id: 'food_braised_pork',
    nameKey: 'travel.food.braised_pork',
    prompt:
      'eating Lu Rou Fan (braised pork rice), small bowl of rice topped with fatty minced pork, savory soy sauce glaze',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 50,
  ...
  {
    id: 'food_iron_egg',
    nameKey: 'travel.food.iron_egg',
    prompt: 'eating Tamsui iron eggs, small dark chewy eggs, waterfront background',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 44,
  ...
  },
  {
    ...
    nameKey: 'travel.food.scallion_pancake',
    prompt:
      'holding a hot Taiwan scallion pancake with egg, crispy layers, street food stall background',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 54,
  ...
  {
    id: 'food_pineapple_cake',
    nameKey: 'travel.food.pineapple_cake',
    prompt: 'tasting a Taiwan pineapple cake, buttery pastry, sweet pineapple jam filling',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 52,
  ...
  {
    id: 'food_agei',
    nameKey: 'travel.food.agei',
    prompt: 'eating Tamsui A-gei, fried tofu stuffed with glass noodles, savory red sauce',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 46,
  ...
  {
    id: 'food_pig_blood',
    nameKey: 'travel.food.pig_blood',
    prompt: 'eating Taiwan pig blood cake on a stick, covered in peanut powder and cilantro',
    group: 'taiwan',
    category: 'food',
    region: 'north',
    x: 48,
  ...
  {
    id: 'food_bawan',
    nameKey: 'travel.food.bawan',
    prompt:
      'eating Changhua meatball (Ba-wan), translucent chewy dough with pork filling, sweet sauce',
    group: 'taiwan',
    category: 'food',
    region: 'central',
    x: 34,
  ...
  {
    id: 'food_oyster_omelet',
    nameKey: 'travel.food.oyster_omelet',
    prompt:
      'eating oyster omelet at a night market, sweet and spicy red sauce, green vegetables inside',
    group: 'taiwan',
    category: 'food',
    region: 'central',
    x: 35,
  ...
  {
    id: 'food_shaved_ice',
    nameKey: 'travel.food.shaved_ice',
    prompt:
      'eating Taiwan mango shaved ice, huge portion of ice topped with fresh mango chunks and condensed milk',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 41,
  ...
  {
    id: 'food_beef_soup',
    nameKey: 'travel.food.beef_soup',
    prompt:
      'eating Tainan fresh beef soup at a local street stall, dipping beef in ginger sauce, morning light',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 38,
  ...
  {
    id: 'food_turkey_rice',
    nameKey: 'travel.food.turkey_rice',
    prompt:
      'eating Chiayi turkey rice, shredded turkey over white rice with fried shallots, simple local diner',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 43,
  ...
  {
    id: 'food_eel_noodle',
    nameKey: 'travel.food.eel_noodle',
    prompt: 'eating Tainan stir-fried eel noodles, crispy eel slices, sweet and sour sauce',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 38,
  ...
  {
    id: 'food_zongzi',
    nameKey: 'travel.food.zongzi',
    prompt:
      'eating a Taiwan Zongzi (sticky rice tamale), sticky rice with peanuts and pork wrapped in leaves',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 46,
  ...
  {
    id: 'food_danzai_noodle',
    nameKey: 'travel.food.danzai_noodle',
    prompt:
      'eating Tainan Danzai noodles, small bowl with minced meat and shrimp, traditional local setting',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 37,
  ...
  {
    id: 'food_coffin_bread',
    nameKey: 'travel.food.coffin_bread',
    prompt: 'eating Tainan coffin bread (Gua Cai Ban), fried toast filled with creamy chowder',
    group: 'taiwan',
    category: 'food',
    region: 'south',
    x: 40,
